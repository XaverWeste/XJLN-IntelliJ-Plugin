...
public class XJLNMethodLongImpl extends ASTWrapperPsiElement implements XJLNMethodLong {

  public XJLNMethodLongImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XJLNVisitor visitor) {
    visitor.visitMethodLong(this);
  }
