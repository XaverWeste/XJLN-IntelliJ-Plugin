...
public class XJLNVarWithoutValueImpl extends ASTWrapperPsiElement implements XJLNVarWithoutValue {

  public XJLNVarWithoutValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XJLNVisitor visitor) {
    visitor.visitVarWithoutValue(this);
  }
